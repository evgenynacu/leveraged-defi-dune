...
> `*` = shared dependency, `[ext]` = external author (read-only)
...
- **Leveraged Strategies Overview (Daily) - v3** ([dune](https://dune.com/queries/5514812), [sql](queries/leveraged_strategies_overview___5514812.sql))
  - [PT] Leveraged Strategies data (daily) ([dune](https://dune.com/queries/5514773), [sql](queries/pt_leveraged_strategies_data___5514773.sql))
    ...
    - Borrow rates (Daily) `*` ([dune](https://dune.com/queries/5333272), [sql](queries/borrow_rates_daily___5333272.sql))
      - Morpho Borrow Rates (Daily) ([dune](https://dune.com/queries/5332727), [sql](queries/morpho_borrow_rates_daily___5332727.sql))
