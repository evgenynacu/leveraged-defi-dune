-- Dune Query 5901329: mHYPER yield rates (Daily)
-- https://dune.com/queries/5901329
...
with day_bounds AS (
  SELECT dt as day_start,
    ...
    select evt_block_time,
           cast(amountUsd as double) / cast(minted as double) as rate
      from midas_rwa_ethereum.mhyperdepositvault_evt_depositinstant
), data as (
    select rate,
           evt_block_time,
